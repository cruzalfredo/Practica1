...
if(isset($_REQUEST['action']))
{
    switch($_REQUEST['action']){
        case "Alta":
            ...
            <form action='asignar-alumnos.php' method='post'  target='_self' >
            ...
            <tr>
                <td>Apellido Materno:</td><td><input type='text' name='apm'><input type='hidden' name='nivel' value='3'><input type='hidden' name='action' value='Alta'></td>
            </tr>
            <tr>
    ...
    <form action='asignar-alumnos.php' method='post'  target='_self' >
        ...
        case "Modificar":
           ...
           echo "
            ...
            <tr>
                <td>Apellido Materno:</td><td><input type='text' name='apm' value='".utf8_decode($apm)."'><input type='hidden' name='nivel' value='3'><input type='hidden' name='modificar' value='$id_a'><input type='hidden' name='action' value='Modificar'></td>
            </tr>
             ";
            if($act==1){
...
if(isset($_REQUEST['submit'])) {
    switch ($_REQUEST['submit']) {
        ...
        case "Buscar":
            ...
            $usuario->readUsuarioS($_REQUEST['buscar'],3);
            echo "<br>";
            echo "<div class=\"alert alert-success\" role=alert>";
            echo "<br> Bot&oacute;n: " . $_REQUEST['submit'];
            echo "</div>";
